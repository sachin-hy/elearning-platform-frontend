       ...
       <Routes>
        ...
        <Route element={
          ...
          <Route path="/dashboard/chat" element={<ChatRoom/>}/>
            <Route element={<CourseProvider><Outlet /></CourseProvider>}>
              <Route path="/dashboard/add-course" element={<CourseInfo/>}/>
              <Route path="/dashboard/sectioninfo" element={<SectionInfo/>}/>
              <Route path="/dashboard/create-section" element={<CreateSection/>}/>
              <Route path="/dashboard/create-subsection" element={<CreateSubsection/>}/>
              <Route path="/dashboard/update-subsection" element={<UpdateSubSection/>}/>
              <Route path="/dashboard/my-courses" element={<MyCourses/>}/>
              <Route path="/dashboard/view-course" element={<ViewCourse/>}/>
            </Route>
        </Route>
